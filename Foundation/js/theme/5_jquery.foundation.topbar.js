...
// Customized File.... changed Line 126, 136, 137 - Changed how the Top Nav Bar works on Mobile 
      ...
      assemble : function () {
        ...
        settings.$section.find('.has-dropdown>a').each(function () {
          var $link = $(this),
              ...
              $titleLi = $('<li class="title back js-generated"><h5><a href=\"#\"></a></h5></li><li><a class="parentLink js-generated show-for-touch" href=\"' + $link.attr('href')+ '\">' + $link.text() +'</a></li>');
